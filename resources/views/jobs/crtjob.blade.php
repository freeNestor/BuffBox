...
<div class="panel panel-info">
        <div id="savejobmsg">aa</div>
   <div class="panel-heading">
      <h3 class="panel-title">Create Job / <a class="" href="#" id="rejoblist">Back</a></h3>
   </div>
            ...
            <form class="form-horizontal" role="form" style="margin-left: 0;">
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     ...
                     <input type="radio" id="relateradio0" name="relastep" value="1" checked="true"/>Relate [stop at failed step]</label>
                     <label class="checkbox">
                     <input type="radio" id="relateradio1" name="relastep" value="0" />Non-Relate [continue next step if step failed]</label>
                  </div>
               </div>
               <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Threads</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="stepparallel" name="" placeholder="5"/>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="steptimeout" name="" placeholder="0"/>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="jobtimeout" name="" placeholder="0"/>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="nodefilter" name="" placeholder=""/>
